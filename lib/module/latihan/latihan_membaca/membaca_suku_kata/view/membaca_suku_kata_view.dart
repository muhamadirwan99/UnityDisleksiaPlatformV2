...
import 'package:udp_v2/module/latihan/latihan_membaca/membaca_suku_kata/widget/content_membaca_suku_kata.dart';
    ...
    return GetBuilder<MembacaSukuKataController>(
      ...
      builder: (controller) {
        ...
        return Scaffold(
            ...
            body: const SingleChildScrollView(child: ContentMembacaSukuKata()));
      },
    );
  }
}
